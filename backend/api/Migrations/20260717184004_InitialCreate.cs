        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorType = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Uri = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    HttpMethod = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    RequestData = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
                    ResponseData = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiLogs_AspNetUsers_AppUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: false),
                    Goal = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Yesterday = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    TodayPlan = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                    Blockers = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DailyUpdates_Sprints_SprintId",
                        column: x => x.SprintId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskActivityLogs_AspNetUsers_PerformedByUserId",
                        column: x => x.PerformedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TaskActivityLogs_TaskItems_TaskItemId",
                        column: x => x.TaskItemId,
                        principalTable: "TaskItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskComments_AspNetUsers_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { "Manager", "role-manager", "Manager", "MANAGER" },
                    { "ScrumMaster", "role-scrummaster", "ScrumMaster", "SCRUMMASTER" },
                    { "TeamLead", "role-teamlead", "TeamLead", "TEAMLEAD" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { -12, "Permission", "daily-updates.submit", "Developer" },
                    { -11, "Permission", "tasks.update.own", "Developer" },
                    { -10, "Permission", "daily-updates.review", "TeamLead" },
                    { -9, "Permission", "tasks.assign", "TeamLead" },
                    { -8, "Permission", "tasks.assign", "Manager" },
                    { -7, "Permission", "projects.manage", "Manager" },
                    { -6, "Permission", "sprints.manage", "ScrumMaster" },
                    { -5, "Permission", "tasks.assign", "ScrumMaster" },
                    { -4, "Permission", "projects.manage", "ScrumMaster" },
                    { -3, "Permission", "tasks.assign", "Admin" },
                    { -2, "Permission", "users.manage", "Admin" },
                    { -1, "Permission", "projects.manage", "Admin" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_ApiLogs_AppUserId",
                table: "ApiLogs",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DailyUpdates_ProjectId_UpdateDate",
                table: "DailyUpdates",
                columns: new[] { "ProjectId", "UpdateDate" });

            migrationBuilder.CreateIndex(
                name: "IX_DailyUpdates_ProjectId_UserId_UpdateDate",
                table: "DailyUpdates",
                columns: new[] { "ProjectId", "UserId", "UpdateDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DailyUpdates_SprintId",
                table: "DailyUpdates",
                column: "SprintId");

            migrationBuilder.CreateIndex(
                name: "IX_DailyUpdates_UserId_UpdateDate",
                table: "DailyUpdates",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskActivityLogs_PerformedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskItems_AssignedToUserId_DueDate",
                table: "TaskItems",
